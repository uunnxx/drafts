...
mkdir -p $HOME/.local/share/fonts/Iosevka && \
  cp $HOME/Documents/fonts/Iosevka.zip $HOME/.local/share/fonts/Iosevka && \
...
mkdir -p $HOME/.local/share/fonts/Hack && \
  cp $HOME/Documents/fonts/Hack.zip $HOME/.local/share/fonts/Hack && \
...
mkdir -p $HOME/.local/share/fonts/FiraCode && \
  cp $HOME/Documents/fonts/FiraCode.zip $HOME/.local/share/fonts/FiraCode && \
