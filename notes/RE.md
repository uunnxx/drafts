...
- [Reversing](https://web.archive.org/web/20210217192600/https://artik.blue/reversing)
- [RE for Beginners](https://www.begin.re/the-workshop)


# Resources
- [A FREE comprehensive reverse engineering tutorial covering x86, x64, 32-bit ARM & 64-bit ARM architectures](https://github.com/mytechnotalent/Reverse-Engineering)
    - https://github.com/uunnxx/Reverse-Engineering-Resources
- [A curated list of awesome threat deteection and hunting resources](https://github.com/0x4D31/awesome-threat-detection)
...
- [DDexec - A Technique to Run Binaries Filelessly and Stealthily on Linux Using DD to Replace the Shell with Another Process](https://www.kitploit.com/2022/04/ddexec-technique-to-run-binaries.html)
