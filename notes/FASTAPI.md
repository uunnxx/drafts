...
### Articles
- [7 Things I wish I knew about Python FastAPI](https://levelup.gitconnected.com/7-things-i-wish-i-knew-about-python-fastapi-a9723499a513)
...
### Codes
- [FastAPI rate limiter](https://github.com/jeremiahtalamantes/fastapi-rate-limiter)


#### Deployment
    - [Deploy a FastAPI app with NGINX and Gunicorn](https://medium.com/@kevinzeladacl/deploy-a-fastapi-app-with-nginx-and-gunicorn-b66ac14cdf5a)
