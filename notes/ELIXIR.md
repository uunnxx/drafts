## Medium Articles
- [String Encodings Decoded with Elixir](https://betterprogramming.pub/string-encodings-decoded-4818b4e30cb3)

## HEX
- [A smart redirecting gateway for various frontend services](https://github.com/benbusby/farside)


## Articles
- [Elixir Pattern Matching Magic](https://dev.to/alexburlacu/elixir-pattern-matching-magic-2i9j)
