...
- [Python tarfile directory traversal](https://davidhamann.de/2022/09/23/python-tarfile-vulnerability/)
- [`nginx` alias misconfiguration allowing path traversal](https://davidhamann.de/2022/08/14/nginx-alias-traversal/)


### Exploits
- [Alex Plaskett on X: A Thread About Remote Kernel Exploits. part1](https://twitter.com/alexjplaskett/status/1693225871195177371)
